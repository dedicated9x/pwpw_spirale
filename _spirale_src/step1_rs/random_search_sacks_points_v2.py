...
# -*- coding: utf-8 -*-
"""
random_search_sacks_points_v2.py
...
Wyjścia (tylko overlay PNG):
  /home/admin2/Documents/repos/pwpw/_spirale/outputs/random_search/overlay_<paramy>_n{count}.png
"""
...
DEFAULT_OUT = "/home/admin2/Documents/repos/pwpw/_spirale/outputs/random_search_narrow_v2"
...
def detect_points(input_img: str, output_img: str, params_dict: dict):
    ...
    Zwraca dict z liczbą detekcji i listą punktów.
    """
...
def main():
    ...
    for _ in tqdm(range(args.trials), desc="Random search", ncols=100):
        ...
        # zapis tymczasowy → po detekcji zmienimy nazwę na docelową z sufiksem _n{count}
        ...
        try:
            ...
            # jeśli coś poszło nie tak przy zapisie, pomiń rename
            final_path = None
